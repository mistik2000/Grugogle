    ...
    <article>
        ...
        <div class="blok">
            <div class="fonrab">
                ...
                <p class="rabot">Для работодателя</p>
                <p class="text">Мы можем помочь подобрать наиболее подходящий тариф для решения ваших задачь.</p>
                <p class="text2">Номер телефона: 89267589436 Email: grugogler@gmail.com</p>
            </div>
            <div class="fonsois">
                <img class="soisk" src="./img/soisk.png" alt="soisk">
                <p class="sois">Для соискателя</p>
                <p class="text3">Если у вас возникли проблемы с сайтом обращайтесь к нашим менеджерам.</p>
                <p class="text4">Номер телефона: 89254897568 Email: grugogles@gmail.com</p>
            </div>
        </div>
        <div class="bl">
            <div>
        <p class="text5">Наши офисы</p>
        <p class="text6">Юридический адрес</p>
        <p class="text7">г. Москава Варшавское шоссе д.125</p>
        <p class="text8">Фактический адрес</p>
        <p class="text9">г. Москава ул. Чертановска  д.42к1</p>
        </div>
        <div class="karta">
        <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A37d18530537bac286e6cdf1dc32db9dec1a8fb0b754dede118a17a5c763d78b7&amp;source=constructor" width="550" height="346"></iframe>
        </div>
        </div>
    </article>
    <footer>
