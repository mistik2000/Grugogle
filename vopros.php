...
<?php // регистрация 
    ...
    mysqli_query($db, "INSERT INTO `Questions` (`Team`, `Question`, `Other`, `ID_Users`) VALUES ('" . $team . "','" . $vap . "','Ваш вопрос принят, скоро мы вам ответим','".$_SESSION['ID_Users']."')"); 
    ...
    <article>
        <div id="vakansi" class="animate form">
            ...
            <form  action="#" method="post" name="form_register">
                <h1 class="vh">Задайте вопрос</h1>
                    <input name="team" required="required" type="text" placeholder="Тема вопроса"/>
                    <input name="vap" required="required" type="text" placeholder="Вопрос" />
                    <button name="ot" type="submit">Отправить вопрос</button>
            </form>
        </div>
